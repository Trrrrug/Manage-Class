            ...
            <div class="card-body">
                ...
                <div class="auth-brand text-center ">
                    <a href="" class="logo-dark">
                        <span><img src="{{asset('img/logo.svg')}}" alt="" height="75"></span>
                    </a>
...
{{--                        </ul>--}}
    ...
    <div class="auth-fluid-right text-center" style="position: relative;">
        <img src="{{asset('img/bg.jpg')}}" style="position: absolute; inset: 0;" />
